 ...
 *
 * This tracker maintains a thread-safe, atomic snapshot of the pages and tiles currently visible or
 * required by the UI. It serves as the source of truth for background workers to determine which
 * rendering tasks are still relevant and prevents the publication of stale results from previous
 * sessions or scrolled-away regions.
 */
