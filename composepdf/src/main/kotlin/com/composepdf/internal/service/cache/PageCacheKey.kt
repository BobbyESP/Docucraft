 ...
 *
 * This data class encapsulates the necessary parameters to distinguish between different cached
 * page images, typically including the document source, the page index, and rendering dimensions or
 * quality settings.
 *
 ...
 */
data class PageCacheKey(val pageIndex: Int, val zoomLevel: Float, val width: Int, val height: Int)
