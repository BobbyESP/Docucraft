...
class TilePlannerTest {
    ...
    fun computeTilePlan_prioritizesVisibleTilesAndAddsPrefetchPage() {
        ...
        val plan =
            planner.computeTilePlan(
                viewport = ViewportState(width = 500f, height = 500f, panX = 0f, panY = -540f),
                layout = layout,
                zoom = 2f,
                visiblePages = 1..1,
    ...
    fun computeTilePlan_addsViewportHaloTilesForVisiblePage() {
        ...
        val plan =
            planner.computeTilePlan(
                viewport = ViewportState(width = 200f, height = 100f, panX = 0f, panY = 0f),
                layout = layout,
                zoom = 2f,
                visiblePages = 0..0,
    ...
    fun computeTilePlan_skipsAlreadyCachedTiles() {
        ...
        val plan =
            planner.computeTilePlan(
                viewport = ViewportState(width = 500f, height = 500f, panX = 0f, panY = 0f),
                layout = layout,
                zoom = 1.3f,
                visiblePages = 0..0,
                scrollDirectionHint = 0,
