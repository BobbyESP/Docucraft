 ...
 */
fun FontConfig.toFontFamily(): FontFamily? = when (this) {
 ...
 */
@Composable
fun ThemeConfig.isDarkTheme(): Boolean = when (this) {
 ...
 */
fun PaletteStyleConfig.toPaletteStyle(): PaletteStyle = when (this) {
