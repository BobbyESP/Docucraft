...
fun materialSharedAxisX(
    ...
    initialOffsetX = initialOffsetX, durationMillis = durationMillis
) togetherWith materialSharedAxisXOut(
    targetOffsetX = targetOffsetX, durationMillis = durationMillis
)
...
fun materialSharedAxisY(
    ...
    initialOffsetY = initialOffsetX, durationMillis = durationMillis
) togetherWith materialSharedAxisYOut(
    targetOffsetY = targetOffsetY, durationMillis = durationMillis
)
...
fun materialSharedAxisZ(
    ...
    forward = forward, durationMillis = durationMillis
