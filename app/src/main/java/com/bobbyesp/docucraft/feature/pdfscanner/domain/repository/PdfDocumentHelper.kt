...
interface PdfDocumentHelper {
     ...
     *
     * This function extracts a single page from the provided PDF file and saves it as an image
     * in the specified output file. It supports various image formats and quality settings.
     *
     ...
     * @param format The image format to use for saving (e.g., PNG, JPEG, WEBP).
     *               Defaults to [Bitmap.CompressFormat.PNG].
     * @param quality The quality of the image compression (0-100, where 100 is the best quality).
     *                Only applicable for lossy formats like JPEG and WEBP.
     *                Defaults to 100.
     * @throws IllegalArgumentException if the `pdfFile` or `outputFile` does not exist,
     *                                  or if the format is not a supported format.
     * @throws RuntimeException if there is an error during the PDF page extraction or image saving process.
     */
