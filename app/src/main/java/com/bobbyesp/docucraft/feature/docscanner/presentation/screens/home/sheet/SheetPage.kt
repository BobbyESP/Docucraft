 ...
 *
 * Using a sealed interface for navigation pages ensures stable backstack entries, decoupling the
 * navigation state from the specific document data being modified.
 */
