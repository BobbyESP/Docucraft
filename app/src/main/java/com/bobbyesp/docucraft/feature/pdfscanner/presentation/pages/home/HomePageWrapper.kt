...
fun HomePageWrapper() {
    ...
    var pdfToBeRemoved by rememberSaveable(key = "pdfToBeRemoved") { mutableStateOf<Uri?>(null) }
    ...
    HomePage(scannedPdfsState = scannedPdfsState, onEvent = vm::onEvent)
}
